...
export class BookResource {
  ...
  getBookContent = (bookId: any): Promise<BookDetailResponse> => this.axios.get('book/'+bookId, this.axiosRequestConfig).then((r) => r.data);
  ...
  getMyReviews = (): Promise<any> => this.axios.get('book/my-reviews', this.axiosRequestConfig).then((r) => r.data);
